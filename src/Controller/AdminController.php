...
class AdminController
{
    ...
    public static function admin()
    {
        ...
        $stringTableJeux = ""; //la variable ne vaut rien parce qu'on n'a pas cliqué le bouton
        $nomBoutonJeux = "Montrer jeux"; //au debut le bouton va montrer ça

        $stringTableUsers = ""; //la variable ne vaut rien parce qu'on n'a pas cliqué le bouton
        ...
        else
        {
            ...
            if ($montrerJeux == "yesJeux" && $_SESSION['btnJeux'])
            {
                ...
                $_SESSION['btnJeux'] = false; //on met dans la session false pour savoir qu'on a cliqué
                $nomBoutonJeux = "Cacher jeux";
            }
            else
            {
                $stringTableJeux = ""; // on met la variable à rien pour rien montrer
                $_SESSION['btnJeux'] = true; //on met dans la session true pour savoir qu'on a cliqué une deuxieme fois
            ...
            if ($montrerUsers == "yesUsers" && $_SESSION['btnUser'])
            {
                ...
                $_SESSION['btnUser'] = false; //on met dans la session false pour savoir qu'on a cliqué
                $nomBoutonUsers = "Cacher users";
            }
            else
            {
                $stringTableUsers = ""; // on met la variable à rien pour rien montrer
                $_SESSION['btnUser'] = true; //on met dans la session true pour savoir qu'on a cliqué une deuxieme fois
